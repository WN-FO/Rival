...
export default function Footer() {
  ...
  const footerNavigation = {
    sports: [
      { name: 'NFL', href: '/?sport=NFL' },
      { name: 'NBA', href: '/?sport=NBA' },
      { name: 'MLB', href: '/?sport=MLB' },
      { name: 'NHL', href: '/?sport=NHL' },
      { name: 'College Football', href: '/?sport=NCAAF' },
      { name: 'College Basketball', href: '/?sport=NCAAB' },
    ],
    features: [
      { name: 'Articles', href: '/' },
      { name: 'Picks', href: '/picks' },
      { name: 'Leaderboard', href: '/leaderboard' },
      { name: 'User Profiles', href: '/leaderboard' },
    ],
    company: [
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="mt-8 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-sm font-semibold leading-6 text-gray-900">Sports</h3>
